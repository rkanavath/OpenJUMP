 ...
 *  to stop the iterative solution (currently 30 steps = userinput), a change 
...
public class BuildingSpreadNarrowPartsPlugIn extends AbstractPlugIn implements ThreadedPlugIn{
    ...
    private static String T4 = "Do only move Edges?";
	...
	private FeatureCollection changeWidth(PlugInContext context, int scale, 
	                           boolean fixVertex, boolean solveIterative, TaskMonitor monitor) throws Exception{
