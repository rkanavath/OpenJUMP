 ...
 * 
 * description:
 * 	tests if the distance among two lines is under a threshold
 * 	and returns the displacement vectors.
 *  Before: apply calcDisplacementVectors();
 * 
 * If dist[m] < field: "crucialDistance", then it is complicate 
 * to give a displacement direction.
...
public class LineLineDistance {
    ...
    private LineString linA;
    private LineString linB;
    private Geometry bufferLineA = null;
    private Geometry bufferLineB = null;
...
//  private ArrayList minWidthDoubleList = new ArrayList();
    ...
    private double signatureA = 0;
    private double signatureB = 0;
    private double threshold = 0;
    private boolean identityFirstPtLineA = false;
    private boolean identityLastPtLineA = false;
     ...
     */
    public LineLineDistance(LineString lineToTest, LineString otherLine, double minDist, double lineASignatureWidth, double lineBSignatureWidth){
        ...
        **/
        ...
        //else{
	        ...
	        if (bufferLineA.disjoint(this.bufferLineB) == false){
	 ...
	 * @param baseRing
	 * @param testRing
     * @param which of them is the polygon, 
...
//		                    dyAct = ClosestVector[0].getCoordinate().y - ClosestVector[1].getCoordinate().y;		                    
     ...
     * 			saved as LineString 
     */    
    public List getDispVecListPtPtLSThisLine() {
     ...
     * 			saved as LineString 
     */
    public List getDispVecListPtEgLSThisLine() {
     ...
     * 			saved as LineString 
     */    
    public List getDispVecListPtPtLSOtherLine() {
     ...
     * 			saved as LineString 
     */
    public List getDispVecListPtEgLSOtherLine() {
