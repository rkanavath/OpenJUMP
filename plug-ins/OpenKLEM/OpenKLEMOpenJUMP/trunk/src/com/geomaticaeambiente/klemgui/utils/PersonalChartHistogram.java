...
public class PersonalChartHistogram {  
    ...
    public JPanel buildHistogramPanel(final JComponent parent, Histogram histogram) {

        // Build graph ---------------------------------------------------------
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        
        LinkedHashMap<ValuesRange, Double> values_hm = histogram.getAreaValues();
        String series = "Area";
        ...
        double firstMaxVal = ((ValuesRange) values_hm.keySet().toArray()[0]).getMaxValue();
        ...
        JLabel min_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.min"));
        ...
        JLabel max_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.max"));
        ...
        JLabel mean_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.mean"));
        ...
        JLabel mean_s = new JLabel(createLabel(histogram.getMean(), decForm00));
        ...
        JLabel stDev_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.stdDev"));
        ...
        JLabel stDev_s = new JLabel(createLabel(histogram.getStdDev(), decForm00));
        ...
        JLabel sum_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.sum"));
        ...
        JLabel area_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.area"));
        ...
        JLabel area_s = new JLabel(createLabel(histogram.getArea(), decForm00));
        ...
        JLabel mode_l = new JLabel(PluginUtils.getResources().getString("ChartHistogram.labels.mode"));
        ...
        JButton csvButton = new JButton(PluginUtils.getResources().getString("ChartHistogram.csvButton.text"));
    ...
    private final DecimalFormatSymbols decForSymb = new DecimalFormatSymbols(Locale.ENGLISH);
    private final DecimalFormat decForm0 = new DecimalFormat("0", decForSymb);
    private final DecimalFormat decForm00 = new DecimalFormat("0.00", decForSymb);
