...
public class SaveDxfFileDataSourceQueryChooser extends SaveFileDataSourceQueryChooser {
    ...
    protected Map toProperties(File file) {
        ...
        Layerable selectedLayer = context.getLayerableNamePanel().getSelectedLayers()[0];
        ...
        if (selectedLayer instanceof Layer) {
            ...
            if (fs.hasAttribute("LAYER")) {
                ...
                List<Feature> features = ((Layer)selectedLayer).getFeatureCollectionWrapper().getFeatures();
                ...
                String[] set = layerSet.toArray(new String[layerSet.size()]);
