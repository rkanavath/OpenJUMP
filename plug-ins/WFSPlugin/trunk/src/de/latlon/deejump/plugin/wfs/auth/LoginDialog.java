...
public class LoginDialog extends JDialog {
    ...
    private void initGUI(String serverName) {
        ...
        getContentPane().add(new JLabel(Messages.getString("LoginDialog.service")), gb);
        ++gb.gridy;
        getContentPane().add(new JLabel(Messages.getString("LoginDialog.username")), gb);
        ++gb.gridy;
        getContentPane().add(new JLabel(Messages.getString("LoginDialog.password")), gb);
        ...
        JButton ok = new JButton(Messages.getString("LoginDialog.ok"));
