...
/**
 * This class wraps an OpenJUMP vector layer, so it can be used by SEXTANTE. It will also be used by SEXTANTE algorithms to create
 * new vector layers from algorithms, so they are based on the OpenJUMP data model
 * 
 * @author volaya
 * 
 */
public class OpenJUMPVectorLayer
         extends
            AbstractVectorLayer {
