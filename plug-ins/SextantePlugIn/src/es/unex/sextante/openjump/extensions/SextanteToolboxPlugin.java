...
public class SextanteToolboxPlugin
   ...
   public void initialize(final PlugInContext context) throws Exception {
	  ...
	  try{
		  Sextante.initialize(jarspath); // needs to be there for the distribution to load the algorithms,
		...
		System.out.println("Check for problems with Sextante initialization, path for libs and resources: " + jarspath);
		System.out.println("Check if image 'terminal.png' exist");
		System.out.println("Check also for Sextante help classes path: " + getHelpPath());
		System.out.println("=> Will do 2nd try with OJ-IDE-Dev settings: " );
		// == do a second trial ==
		String idePathSextante = System.getProperty("user.dir") + "/lib/plus/sextante";
		String idePathSHelp = System.getProperty("user.dir") + "/lib/plus/sextante_help";
		System.out.println("=> looking for algorithms and image in: " + idePathSextante);
		try{
