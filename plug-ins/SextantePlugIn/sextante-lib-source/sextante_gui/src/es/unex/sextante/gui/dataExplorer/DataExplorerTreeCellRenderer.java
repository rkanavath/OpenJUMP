...
public class DataExplorerTreeCellRenderer
   ...
   private final ImageIcon m_ImageIcon;
   ...
   public DataExplorerTreeCellRenderer() {
      ...
      m_ImageIcon = new ImageIcon(getClass().getClassLoader().getResource("images/image_layer.gif"));
   ...
   private Icon getCustomIcon(final Object value) {
      ...
      if (obj instanceof String) {
         ...
         if (obj.equals(Sextante.getText("Image_layers"))) {
             return m_ImageIcon;
         }
