...
public class ToolboxPanel extends JPanel {
     ...
     * @param filter
     *            the filter to apply to the list of all available algorithms to
     *            configure this toolbox panel
     * @param img
     *            the background image for the algorithm panel. If null, will
     *            use the default one
     */
    ...
    public void initialize() {
        ...
        this.setSize(new java.awt.Dimension(400, 500));
        {
            ...
            algoritmhsPanel = createAlgorithmsPanel(m_Filter, m_Parent);
    ...
    protected AlgorithmsPanel createAlgorithmsPanel(
            final IGeoAlgorithmFilter filter, final IToolboxDialog parent) {

        return new AlgorithmsPanel(parent, filter);
    }
    ...
    /**
     * fills the tree of algorithms with all the available ones, not aplying any
     * filter
     */
    ...
    /**
     * fills the tree of algorithms with all the algorithms containing a given
     * string in their help file
     * 
     * @param string
