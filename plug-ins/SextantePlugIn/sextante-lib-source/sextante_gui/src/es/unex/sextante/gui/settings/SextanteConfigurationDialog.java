...
//import org.openjump.alg.GridCalculatorAlgorithm;
...
public class SextanteConfigurationDialog extends JDialog {
    ...
    private static int INIT_WIDTH = 640;
    private static int INIT_HEIGHT = 540;
     ...
     * 
     * @param panel
     *            the current toolbox panel. It will be updated with the changes
     *            made in this dialog
     * @param parent
    ...
    public SextanteConfigurationDialog(final ToolboxPanel panel,
        ...
        super(parent, Sextante.getText("Processing") + " - "
                + Sextante.getText("Settings"), true);
    ...
    public SextanteConfigurationDialog(final ToolboxPanel panel) {
        ...
        super(SextanteGUI.getMainFrame(), Sextante.getText("Processing")
                + " - " + Sextante.getText("Settings"), true);

        final Setting[] settings = new Setting[] { new SextanteGeneralSettings() }; // add
                                                                                    // more
                                                                                    // Setting
                                                                                    // objects
                                                                                    // here
    ...
    private void initGUI() {
        ...
        final TableLayout thisLayout = new TableLayout(
                new double[][] {
                        { 3.0, 160.0, TableLayoutConstants.FILL, 150.0, 3.0,
                                150.0, 3.0 },
        ...
        // [2016_09_11 Giuseppe Aruta] added "Sextante for OpenJUMP" as this
        // version is a working fork from Sextante GvSIG CE 1.0.0 (which was not
        // working with OpenJUMP)
        {
            jLabelVersion = new JLabel();
            // ///////////////////////////////////////////
            jLabelVersion.setText("<html><i>" + "Sextante for OpenJUMP" + "\n"
                    + Sextante.getText("version") + " "
