...
import es.unex.sextante.gui.modeler.parameters.ImageLayerPanel;
...
JPanel {
	...
	private void fillTree() {
		...
		layersNode.add(node);
		node = new DefaultMutableTreeNode(getNewImageLayerPanel());
		layersNode.add(node);
	...
	private Object getNewImageLayerPanel() {

		if (m_Parent != null) {
			return new ImageLayerPanel(m_Parent, m_ModelerPanel);
		}
		else {
			return new ImageLayerPanel(m_ModelerPanel);
		}
