...
public class ScriptEditingPanel extends JPanel
{
	...
	protected void save() {
		...
		final GenericFileFilter filter = new GenericFileFilter("bsh", "Processing BeanShell Script");
	...
	protected void open() {
		...
		final String sFolder = SextanteGUI.getSettingParameterValue(SextanteScriptsSettings.SCRIPTS_FOLDER);
		fc.setFileFilter(new GenericFileFilter("bsh", "Processing BeanShell Script"));
		fc.setCurrentDirectory(new File(sFolder));
