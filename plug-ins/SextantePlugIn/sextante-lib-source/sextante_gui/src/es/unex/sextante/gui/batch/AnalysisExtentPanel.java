...
public class AnalysisExtentPanel extends javax.swing.JPanel {
	...
	private void initGUI() {
		...
		final TableLayout jPanelAnalysisExtentLayout = new TableLayout(new double[][] { { 
			1.0, TableLayoutConstants.FILL, 1.0 }, //Cols
			{ 1.0,/*TableLayoutConstants.FILL,*/ //Rows
				TableLayoutConstants.MINIMUM, TableLayoutConstants.FILL, /*140.0, 120.0,*/
	...
	public void adjustExtent() throws TooLargeGridExtentException, WrongAnalysisExtentException {
		...
		if (!getJRadioButtonAdjustToInputDataExtent().isSelected()) {
			...
			try {
				m_AnalysisExtent.setCellSizeX(Double.parseDouble(jTextFieldCellSizeX.getText()));
				m_AnalysisExtent.setCellSizeY(Double.parseDouble(jTextFieldCellSizeY.getText()));
		...
		if (jPanelAnalysisExtentValues == null) {
			...
			final TableLayout jPanelRasterExtentValuesLayout = new TableLayout(new double[][] {
				...
				{ 	//Rows
					...
					TableLayoutConstants.MINIMUM, //3: Cols/rows count
					TableLayoutConstants.FILL } });
