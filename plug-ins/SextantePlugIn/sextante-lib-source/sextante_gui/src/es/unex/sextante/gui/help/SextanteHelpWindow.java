...
public class SextanteHelpWindow extends JFrame {
    ...
    public void fillTree() {
        ...
        final DefaultMutableTreeNode pluginNode = new DefaultMutableTreeNode(
        ...
        generalNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                "Introduction", HelpIO.getHelpFile("intro"))));
        generalNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                "OpenJUMP and Sextante data", HelpIO.getHelpFile("openjump"))));

        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_toolbox"), HelpIO
                        .getHelpFile("toolbox"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_Modeler"), HelpIO
                        .getHelpFile("modeler"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_History"), HelpIO
                        .getHelpFile("history"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_command_line"), HelpIO
                        .getHelpFile("cmd"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_Results"), HelpIO
                        .getHelpFile("results"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_Data_Explorer"), HelpIO
                        .getHelpFile("explorer"))));
        pluginNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(
                Sextante.getText("SEXTANTE_Picker"), HelpIO
                        .getHelpFile("coordinates"))));

        additional_information.add(new DefaultMutableTreeNode(
                new ObjectAndDescription(Sextante.getText("Batch_processing"),
                        HelpIO.getHelpFile("batch"))));

        additional_information.add(new DefaultMutableTreeNode(
                new ObjectAndDescription(Sextante
                        .getText("ConfiguringProviders"), HelpIO
                        .getHelpFile("providers"))));

        mainNode.add(generalNode);
        mainNode.add(pluginNode);
        mainNode.add(additional_information);
    ...
    //
    // if (root != null) {
    // for (final Enumeration e = root.breadthFirstEnumeration();
    // e.hasMoreElements();) {
    // final DefaultMutableTreeNode current = (DefaultMutableTreeNode)
    // e.nextElement();
    // ob = current.getUserObject();
