...
public class DefaultGUIFactory implements IGUIFactory {
    ...
    public int showAlgorithmDialog(final GeoAlgorithm alg,
            final JDialog parent, final ArrayList<DateAndCommand> commands) {

        GeoAlgorithmParametersPanel paramPanel = null;
        Class paramPanelClass = SextanteGUI.getParametersPanel(alg
                .getCommandLineName());
        ...
        try {
            paramPanel = (GeoAlgorithmParametersPanel) paramPanelClass
                    .newInstance();
        } catch (final Exception e) {
            try {
                paramPanel = (GeoAlgorithmParametersPanel) getDefaultParametersPanel()
                        .newInstance();
    ...
    public int showAlgorithmDialogForModeler(final GeoAlgorithm algorithm,
            final String sName, final String sDescription,
            final ModelAlgorithm modelAlgorithm, final HashMap dataObjects,
            final JDialog parent) {

        GeoAlgorithmModelerParametersPanel paramPanel = null;
        Class paramPanelClass = SextanteGUI.getModelerParametersPanel(algorithm
                .getCommandLineName());
        ...
        try {
            paramPanel = (GeoAlgorithmModelerParametersPanel) paramPanelClass
                    .newInstance();
        } catch (final Exception e) {
            try {
                paramPanel = (GeoAlgorithmModelerParametersPanel) getDefaultModelerParametersPanel()
                        .newInstance();
            } catch (final Exception e1) {
            }
        }
        ...
        try {
            ...
            if (parent != null) {
                dialog = new es.unex.sextante.gui.modeler.AlgorithmDialog(
                        algorithm.getNewInstance(), sName, sDescription,
    ...
    public void showModelerDialog() {
        ...
        final ModelerDialog dialog = new ModelerDialog(
                SextanteGUI.getMainFrame());
        dialog.pack();
        dialog.setVisible(true);
    ...
    public void showHelpEditionDialog(final GeoAlgorithm alg) {
        ...
        final HelpEditionDialog dialog = new HelpEditionDialog(alg,
                SextanteGUI.getMainFrame());
        dialog.pack();
        dialog.setVisible(true);
    ...
    public void showHelpDialog(final GeoAlgorithm algorithm) {
        ...
        SextanteGUI.getGUIFactory().showGenericInfoDialog(scrollPane,
    ...
    public void showAdditionalResultsDialog(final ArrayList components) {
        ...
        if (components.size() != 0) {
            final Runnable runnable = new Runnable() {
                public void run() {
                    final AdditionalResultsDialog dialog = new AdditionalResultsDialog(
                            components, SextanteGUI.getMainFrame());
                    dialog.pack();
                    dialog.setVisible(true);
                }
            };
    ...
    public void showHistoryDialog() {
        ...
        final HistoryDialog dialog = new HistoryDialog(
                SextanteGUI.getMainFrame());
    ...
    public void showGenericInfoDialog(final Component component,
        ...
        final GenericInfoDialog dialog = new GenericInfoDialog(component, text,
                SextanteGUI.getMainFrame());
        dialog.setVisible(true);
    ...
    public void showBatchProcessingFromGISDialog(final GeoAlgorithm alg,
        ...
        if (parent != null) {
            dialog = new es.unex.sextante.gui.batch.nonFileBased.BatchProcessDialog(
                    alg, parent);
        } else {
            dialog = new es.unex.sextante.gui.batch.nonFileBased.BatchProcessDialog(
                    alg);
    ...
    public void showDataExplorer() {
        ...
        final DataExplorerDialog dialog = new DataExplorerDialog(
                SextanteGUI.getMainFrame());
        dialog.pack();
        dialog.setVisible(true);
    ...
    public void showGenericDialog(final String name, final Component component) {

        final GenericDialog dialog = new GenericDialog(component, name,
                SextanteGUI.getMainFrame());
        dialog.pack();
        dialog.setVisible(true);
