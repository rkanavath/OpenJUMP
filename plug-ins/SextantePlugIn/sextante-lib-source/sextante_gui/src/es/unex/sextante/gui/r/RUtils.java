...
public class RUtils {
   ...
   private static String getRScriptFilename() {
      ...
      final String sFile = Sextante.getUserFolder() + File.separator + "sextante_script.r";
   ...
   private static String getConsoleOutputFilename() {
      ...
      final String sFile = Sextante.getUserFolder() + File.separator + "sextante_script.r.Rout";
