...
/**
 * A panel with a text field and a button. The text field shows a text
 * representation of a fixed table. Clicking on the button shows a dialog to
 * fill the data of the fixed table
 *
 * @author volaya
 *
 */
public class FixedTablePanel extends JPanel {
     ...
     */
    public FixedTablePanel(final String[] sColumnNames, final int iNumRows,
            final boolean bIsNumberOfRowsFixed) {

        super();

        m_FixedTableModel = new FixedTableModel(sColumnNames, iNumRows,
    ...
    private void btnActionPerformed(final ActionEvent e) {
        ...
        final FixedTableDialog dialog = new FixedTableDialog(
                SextanteGUI.getMainFrame(), m_FixedTableModel);
