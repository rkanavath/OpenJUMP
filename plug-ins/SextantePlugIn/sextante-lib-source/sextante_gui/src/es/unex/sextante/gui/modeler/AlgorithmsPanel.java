...
public class AlgorithmsPanel
   ...
   public boolean isAlgorithmEnabled(final GeoAlgorithm alg) {
	   ...
	   boolean bRequiresImageLayers = alg.requiresImageLayers();
	   ...
	   boolean bImageRequirementsMet = !bRequiresImageLayers;
	   ...
	   bAllRequirementsMet = bRasterRequirementsMet && b3DRasterRequirementsMet && bImageRequirementsMet 
	   && bVectorRequirementsMet && bTableRequirementsMet
	   ...
	   while (iter.hasNext() && !bAllRequirementsMet) {
		   ...
		   if ( oad.getObject() != null ) {
			   ...
			   if (dataClass == ModelElementRasterLayer.class || dataClass == ModelElementImageLayer.class) {
				   if (isParameterMandatory(sKey)) {
					   bRasterRequirementsMet = true;
				   }
			   }
			   if (dataClass == ModelElementImageLayer.class) {
				   if (isParameterMandatory(sKey)) {
					   bImageRequirementsMet = true;
				   }
			   }
			   ...
			   bAllRequirementsMet = bRasterRequirementsMet && b3DRasterRequirementsMet && bImageRequirementsMet 
			   && bVectorRequirementsMet && bTableRequirementsMet && bPointRequirementsMet
			   && bPolygonLayerRequirementsMet && bLineLayerRequirementsMet && bPointLayerRequirementsMet;
		   } else {
			   Sextante.addWarningToLog ("AlgorithmsPanel.java: isAlgorithmEnabled(): Got NULL object.");
			   System.out.println ("Processing: AlgorithmsPanel.java: isAlgorithmEnabled(): Got NULL object.");
