...
public class TableFieldPanel
   ...
   protected void initGUI() {
	   ...
	   super.setPreferredSize(new java.awt.Dimension(400, 204));      
   ...
   public void updateOptions() {
      ...
      for (i = 0; i < layers.size(); i++) {
         ...
         oad[i] = new ObjectAndDescription(param.getParameterDescription() + " [" + Sextante.getText("Vector_layer") + "]",
   ...
   protected boolean prepareParameter() {
      ...
      if (sDescription.length() != 0) {
         ...
         final AdditionalInfoTableField addInfo = new AdditionalInfoTableField(sName, jCheckBoxMandatory.isSelected());
