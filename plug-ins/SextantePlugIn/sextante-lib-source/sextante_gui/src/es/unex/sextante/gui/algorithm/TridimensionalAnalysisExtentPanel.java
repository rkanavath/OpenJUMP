...
public class TridimensionalAnalysisExtentPanel extends AnalysisExtentPanel {
	...
	public void assignExtent() throws TooLargeGridExtentException, WrongAnalysisExtentException {
		...
		try {
			...
			outputExtent.setZRange(Double.parseDouble(jTextFieldZMin.getText()), 
		...
		if (jPanelAnalysisExtentValues == null) {
			...
			final TableLayout jPanelRasterExtentValuesLayout = new TableLayout(new double[][] {
				...
				{ 	//Rows
					...
					TableLayoutConstants.MINIMUM, //2: X/Y cell size
					TableLayoutConstants.MINIMUM, //3: Cell size picker
					TableLayoutConstants.MINIMUM, //4: Cols/rows count
					TableLayoutConstants.MINIMUM, //5: Z range
					TableLayoutConstants.MINIMUM, //6: Z cell size
					TableLayoutConstants.MINIMUM, //7: Z levels count
			...
			jPanelAnalysisExtentValues.add(getJButtonExtentFromPoints(), "1, 3");
			...
			jPanelAnalysisExtentValues.add(getJLabelRangeZ(), 		"0, 5");
			jPanelAnalysisExtentValues.add(getJTextFieldZMin(), 	"1, 5");
			jPanelAnalysisExtentValues.add(getJTextFieldZMax(), 	"2, 5");
			jPanelAnalysisExtentValues.add(getJLabelCellSizeZ(), 	"0, 6");
			jPanelAnalysisExtentValues.add(getJTextFieldCellSizeZ(),"1, 6");
			jPanelAnalysisExtentValues.add(getJLabelColsZ(), 		"0, 7");
			jPanelAnalysisExtentValues.add(getJTextFieldColsZ(), 	"1, 7");
		}
