...
public class ModelElementFactory {
   ...
   public static IModelElement getParameterAsModelElement(final Parameter param) {
      ...
      try {
         ...
         if (param instanceof ParameterImageLayer) {
             element = new ModelElementImageLayer();
             ((ModelElementImageLayer) element).setNumberOfBands(ModelElementImageLayer.NUMBER_OF_BANDS_UNDEFINED);
          }
