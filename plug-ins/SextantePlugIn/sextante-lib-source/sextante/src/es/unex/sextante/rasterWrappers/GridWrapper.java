...
public abstract class GridWrapper {
   ...
   private int              m_iInterpolationMethod         = INTERPOLATION_NearestNeighbour;
   protected double     	m_dCellSizeX = 1;               //X cellsize of the layer, not the window
   protected double     	m_dCellSizeY = 1;               //Y cellsize of the layer, not the window
   ...
   public GridWrapper(final IRasterLayer layer,
      ...
      m_dCellSizeX = layer.getLayerCellSizeX();
      m_dCellSizeY = layer.getLayerCellSizeY();
   ...
   public double getCellSizeX() {
      ...
      return m_WindowExtent.getCellSizeX();
   ...
   public double getCellSizeY() {
	   ...
	   return Math.abs(m_WindowExtent.getCellSizeY());
   ...
   public double getValueAt(double xPosition,
      ...
      x = (int) Math.floor(xPosition = (xPosition - m_Layer.getLayerGridExtent().getXMin()) / m_dCellSizeX);
      y = (int) Math.floor(yPosition = (m_Layer.getLayerGridExtent().getYMax() - yPosition) / m_dCellSizeY);
