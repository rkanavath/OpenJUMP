...
public abstract class Parameter {
   ...
   /**
    * Returns the value of the parameter as an image layer (=multiband raster layer)
    * 
    * @return the value of the parameter as an image layer
    * @throws WrongParameterTypeException
    *                 if the parameter cannot be returned as an image layer
    * @throws NullParameterValueException
    *                 if the value is null and it is a mandatory image layer
    * @throws NullParameterAdditionalInfoException
    *                 if the additional info of the parameter is null
    */
   public abstract IRasterLayer getParameterValueAsImageLayer() throws WrongParameterTypeException, NullParameterValueException;
   ...
   /**
    * Returns the additional information of this parameter or null.
    * 
    * @return the additional information of this parameter or null if there isn't any
    */
   public AdditionalInfo getParameterAdditionalInfoOrNull() {
   ...
   /**
    * Returns the "selected" state of this parameter. Useful for various purposes.
    * 
    * @return true or false.
    */
   public boolean getParameterSelected() {
	   return m_bSelected;
   }
   
   /**
    * Sets the "selected" state of this parameter. Useful for various purposes.
    * 
    * @param bSelected.
    * 			selection state ("true" or "false")
    */
   public void setParameterSelected(final boolean bSelected) {
   ...
   public static Parameter deserialize(final KXmlParser parser) throws XmlPullParserException, IOException {
      ...
      if (sClass.equals(Parameter3DRasterLayer.class.toString())) {
          param = Parameter3DRasterLayer.deserialize(parser);
       }
      if (sClass.equals(ParameterImageLayer.class.toString())) {
          param = ParameterImageLayer.deserialize(parser);
      }
