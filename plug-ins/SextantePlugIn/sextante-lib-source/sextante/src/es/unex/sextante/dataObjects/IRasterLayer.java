...
public interface IRasterLayer extends ILayer {
	...
	/**
	 * Return the X cellsize of the query window.
	 * 
	 * @return the X cellsize of the query window
	 */
	public double getWindowCellSizeX();


	/**
	 * Return the Y cellsize of the query window.
	 * 
	 * @return the Y cellsize of the query window
	 */
	public double getWindowCellSizeY();


	/**
	 * Return the original X cellsize of the layer.
	 * 
	 * @return the original cellsize of the layer
	 */
	public double getLayerCellSizeX();


	/**
	 * Return the original Y cellsize of the layer.
	 * 
	 * @return the original cellsize of the layer
	 */
	public double getLayerCellSizeY();
