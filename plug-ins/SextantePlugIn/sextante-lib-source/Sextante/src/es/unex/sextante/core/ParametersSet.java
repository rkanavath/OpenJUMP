...
public class ParametersSet {
   ...
   /**
    * 
    * @return the number of parameters requiring image (=multiband raster) layers
    * 
    */
   public int getNumberOfImageLayers() {
      ...
      for (i = 0; i < m_Parameters.size(); i++) {
         ...
         if (parameter.getParameterTypeName().equals("Image Layer")) {
            iCount++;
            continue;
         }
      }
   ...
   /**
    * Returns true if the set contains parameters requiring image layers
    * 
    * @return true if the set contains parameters requiring image layers
    */
   public boolean requiresImageLayers() {

      if (getNumberOfImageLayers() > 0) {
         return true;
      }
   ...
   public boolean addParameter(final Parameter parameter) throws RepeatedParameterNameException {
      ...
      if ( m_Parameters == null || parameter == null ) {
    	  return false;
      }
    ...
    * @throws WrongParameterTypeException
    *                 if the parameter cannot be converted to an image layer
    * @throws WrongParameterIDException
    *                 if no parameter with that name exists in the set
    * @throws NullParameterValueException
    *                 if the parameter is null
    */
   public IRasterLayer getParameterValueAsImageLayer(final String sParameterName) throws WrongParameterTypeException,
                                                                                  WrongParameterIDException,
                                                                                  NullParameterValueException {
      ...
      return parameter.getParameterValueAsImageLayer();
   ...
   /**
    * Adds an image layer (=multiband raster layer) to the parameter set
    * 
    * @param sName
    *                the name of the parameter
    * @param sDescription
    ...
    *                 if a parameter with the same name already exists in the set
    */
   public void addInputImageLayer(final String sName,
                                   final String sDescription,
                                   final boolean bIsMandatory) throws RepeatedParameterNameException {

      final AdditionalInfoImageLayer additionalInfo = new AdditionalInfoImageLayer(bIsMandatory);

      final ParameterImageLayer parameter = new ParameterImageLayer();
      parameter.setParameterName(sName);
      parameter.setParameterDescription(sDescription);
      parameter.setParameterAdditionalInfo(additionalInfo);
      addParameter(parameter);
