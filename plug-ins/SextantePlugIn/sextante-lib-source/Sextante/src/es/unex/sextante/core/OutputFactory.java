...
public abstract class OutputFactory {
   ...
   private double m_dNoDataValue = Sextante.PRESET_NO_DATA;
    ...
    *                know)
    * @param bSilent
    *                true if the task monitor will monitor a "silent" background process (i.e. there will be no GUI dialog to interact with the monitor/task)
