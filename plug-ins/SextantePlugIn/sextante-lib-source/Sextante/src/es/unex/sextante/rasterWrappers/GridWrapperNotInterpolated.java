...
public class GridWrapperNotInterpolated
   ...
   public GridWrapperNotInterpolated(final IRasterLayer layer,
      ...
      m_dCellSizeX = windowExtent.getCellSizeX();
      m_dCellSizeY = windowExtent.getCellSizeY();
   ...
   protected void calculateOffsets() {
      ...
      m_iOffsetX = (int) ((m_WindowExtent.getXMin() - layerExtent.getXMin()) / m_dCellSizeX);
      m_iOffsetY = (int) ((layerExtent.getYMax() - m_WindowExtent.getYMax()) / m_dCellSizeY);
