...
public abstract class AbstractRasterLayer implements IRasterLayer {
	...
	public double getWindowCellSizeX() {
		return m_GridWrapper.getCellSizeX();
	}


	public double getWindowCellSizeY() {
		return m_GridWrapper.getCellSizeY();
	}
	...
	protected void setConstants() {
		...
		int i;
		final double dCellSizeX = getWindowCellSizeX();
		final double dCellSizeY = getWindowCellSizeY();
		...
		_2DX = ((dCellSizeX+dCellSizeY)/2.0) * 2.0;
