...
public interface SpatialIndex {
   ...
   /**
    * Initializes any implementation dependent properties of the spatial index. For example, RTree implementations will have a
    * NodeSize property.
    *
    * @param props
    ...
    * @param id
    *                The ID of the rectangle to add to the spatial index. The result of adding more than one rectangle with the
    ...
    *
    * @return true if the rectangle was deleted false if the rectangle was not found, or the rectangle was found but with a
    *         different ID
    */
   ...
   /**
    * Finds the nearest point to the passed rectangle.
    *
    * @param p
    *                The point for which this method finds the nearest neighbour.
    *
    * This should be as small as possible to minimise the search time.
    *
    * Use Float.POSITIVE_INFINITY to guarantee that the nearest rectangle is found, no matter how far away, although this will
    ...
    *
    * @param r
    *                The rectangle for which this method finds intersecting rectangles.
    *
    * @param ip
    *                The IntProcedure whose execute() method is is called for each intersecting rectangle.
    */
    ...
    *
    * @param v
    *                The visitor whose visit() method is is called for each contained rectangle.
    */
