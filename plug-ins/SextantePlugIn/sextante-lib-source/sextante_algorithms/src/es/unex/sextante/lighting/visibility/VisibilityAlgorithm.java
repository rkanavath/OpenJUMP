...
GeoAlgorithm {
	...
	public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
		...
		m_iRadius = (int) (m_Parameters.getParameterValueAsInt(RADIUS) / meanCellSize);
					...
					if (m_DEM.isNoDataValue(z)) {
						...
						if (tracePoint(x, y, dx, dy, dz)) {
							...
							case 1: // Shade
								...
								break;
							case 2: // Distance
								m_Visibility.setCellValue(x, y, meanCellSize * Math.sqrt(dx * dx + dy * dy));
								break;
							case 3: // Size
								if ((d = meanCellSize * Math.sqrt(dx * dx + dy * dy)) > 0.0) {
