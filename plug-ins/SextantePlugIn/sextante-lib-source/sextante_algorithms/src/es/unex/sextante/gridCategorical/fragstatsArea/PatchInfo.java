...
public class PatchInfo {
	...
	public double getPerimeter() {
		final double meanCellSize = (m_Window.getWindowCellSizeX()+m_Window.getWindowCellSizeY())/2.0;
		return meanCellSize * m_iPerimeter;
	}
	...
	public double getArea() {
		return m_Window.getWindowCellSizeX() * m_Window.getWindowCellSizeY() * m_iCells;
	}


	public double getRadiusOfGyration() {
		final double meanCellSize = (m_Window.getWindowCellSizeX()+m_Window.getWindowCellSizeY())/2.0;
		return m_dRadiusOfGyration / m_iCells * meanCellSize;
	}
