...
public class FilterVectorParametersPanel
         extends
   ...
   public FilterVectorParametersPanel() {
   ...
   public void assignParameters() throws WrongInputException, LayerCannotBeOverwrittenException {
      ...
      try {
         m_Algorithm.getParameters().getParameter(FilterVectorAlgorithm.LAYER).setParameterValue(layer);
         m_Algorithm.getParameters().getParameter(FilterVectorAlgorithm.FORMULA).setParameterValue(sFormula);
      }
      ...
      final OutputObjectsSet ooSet = m_Algorithm.getOutputObjects();
      try {
         out = ooSet.getOutput(FilterVectorAlgorithm.RESULT);
