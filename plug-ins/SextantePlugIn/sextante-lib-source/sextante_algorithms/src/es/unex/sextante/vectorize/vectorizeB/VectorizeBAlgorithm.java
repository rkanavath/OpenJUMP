...
public class VectorizeBAlgorithm
   ...
   private void createPolygons() throws UnsupportedOutputChannelException {
      ...
      ge.setCellSizeX(wge.getCellSizeX() * .5);
      ge.setCellSizeY(wge.getCellSizeY() * .5);
      ge.setXRange(wge.getXMin() - wge.getCellSizeX() * .5, wge.getXMax() + wge.getCellSizeX() * .5, true);
      ge.setYRange(wge.getYMin() - wge.getCellSizeY() * .5, wge.getYMax() + wge.getCellSizeY() * .5, true);
   ...
   private void Get_Square(final int x,
      ...
      int i, ix, iy;
      final double dCellSizeX = m_Edge.getWindowCellSizeX() * .5;
      final double dCellSizeY = m_Edge.getWindowCellSizeY() * .5;
      ...
      for (i = 0; i < 8; i++) {
         ...
         if (i % 2 != 0) {
            ...
            m_Coords.add(new Coordinate(pt.getX() + dCellSizeX, pt.getY() - dCellSizeY));
         }
      }
   }
