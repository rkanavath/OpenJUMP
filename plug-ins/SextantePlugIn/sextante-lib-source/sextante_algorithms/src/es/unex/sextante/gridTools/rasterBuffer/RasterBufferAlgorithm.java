...
public class RasterBufferAlgorithm
   ...
   public void defineCharacteristics() {
      ...
      try {
         ...
         m_Parameters.addNumericalValue(DIST, Sextante.getText("Distance"), 
   ...
   public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
      ...
      final double meanCellSize = (layer.getWindowCellSizeX()+layer.getWindowCellSizeY())/2.0; 
      dBufDist = m_Parameters.getParameterValueAsDouble("DIST") / meanCellSize;
