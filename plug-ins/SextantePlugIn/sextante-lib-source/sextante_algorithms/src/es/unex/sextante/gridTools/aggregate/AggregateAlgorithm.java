...
public class AggregateAlgorithm
   ...
   public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
      ...
      dCellSizeX = window.getLayerCellSizeX() * iSize;
      dCellSizeY = window.getLayerCellSizeY() * iSize;

      resultExtent = new AnalysisExtent();
      resultExtent.setCellSizeX(dCellSizeX);
      resultExtent.setCellSizeY(dCellSizeY);
      resultExtent.setXRange(ge.getXMin(), ge.getXMin() + iNX * dCellSizeX, true);
      resultExtent.setYRange(ge.getYMin(), ge.getYMin() + iNY * dCellSizeY, true);
