...
public class TabulateAreaAlgorithm
   ...
   public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
      ...
      final double cellArea = m_AnalysisExtent.getCellSizeX() * m_AnalysisExtent.getCellSizeY();
      ...
      try {
         ...
         System.out.println("Cell size X: " + m_AnalysisExtent.getCellSizeX());
         System.out.println("Cell size Y: " + m_AnalysisExtent.getCellSizeY());
