...
public class CropToValidDataAlgorithm
   ...
   private AnalysisExtent getAdjustedGridExtent(final IRasterLayer input) {
      ...
      dCellSizeX = input.getWindowGridExtent().getCellSizeX();
      dCellSizeY = input.getWindowGridExtent().getCellSizeY();
      ...
      dMinX2 = dMinX + iMinX * dCellSizeX;
      dMinY2 = dMaxY - iMaxY * dCellSizeY;
      dMaxX2 = dMinX + iMaxX * dCellSizeX;
      dMaxY2 = dMaxY - iMinY * dCellSizeY;
