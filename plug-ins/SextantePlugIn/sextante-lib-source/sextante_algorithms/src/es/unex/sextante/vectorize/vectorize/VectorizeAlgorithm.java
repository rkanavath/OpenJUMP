...
public class VectorizeAlgorithm
   ...
   private void Discrete_Area(int x,
      ...
      final double dCellSizeX = m_Window.getWindowCellSizeX();
      final double dCellSizeY = m_Window.getWindowCellSizeY();
      ...
      do {
         coordinates.add(new Coordinate(xMin + (x) * dCellSizeX, yMax - (y) * dCellSizeY));
