/*******************************************************************************
LineKernelDensityForMovementTracksAlgorithm.java
...
public class LineKernelDensityForMovementTracksAlgorithm extends GeoAlgorithm {
   ...
   public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
      ...
      m_Result = getNewRasterLayer(RESULT, m_Layer.getName() + "-KD4M",
   ...
   private void writeSegment(double x, double y, double x2, double y2) {
	...
	private void doPoint(double xCoord, double yCoord) {
