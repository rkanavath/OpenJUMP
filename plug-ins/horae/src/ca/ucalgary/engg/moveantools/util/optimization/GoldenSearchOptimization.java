/*
    GoldenSearchOptimization.java and Fmin.java copyright claim:
...
[sstein 23 Nov. 2009] class copied and renamed 
                      from http://www1.fpl.fs.fed.us/Fmin.java
...
* 
*/
public class GoldenSearchOptimization extends Object{
   ...
   *
   */
   public static double fmin (double a, double b, FMinMethods minclass, double tol) {
      ...
      x = v;
      e = 0.0;
      fx = minclass.functionToMinimize(x);
      fv = fx;
      fw = fx;
      tol3 = tol/3.0;
      ...
      while (Math.abs(x-xm) > (t2 - .5*(b-a))) {
         ...
         fu = minclass.functionToMinimize(u);
