...
public class FUTURE_FeatureInstaller extends FeatureInstaller {
    ...
    public void addPopupMenuItem(JPopupMenu popupMenu, PlugIn executable,
        ...
        MenuElement element = createMenusIfNecessary(popupMenu, menuPath);
        if (element instanceof JMenuItem) {
            ((JMenuItem)element).add(menuItem);
    ...
    public MenuElement createMenusIfNecessary(MenuElement parent,
            String[] menuPath) {
        if (menuPath.length == 0) { return (MenuElement)parent; }
