...
public class CSLayerSetExtension
	...
	public void configure(PlugInContext context) throws Exception {
		new CSLayerSetExtension().initialize(context);
	}
	...
	static public String getBase(){
		...
		URL whereami = CSLayerSetExtension.class.getProtectionDomain().getCodeSource().getLocation();
	...
	static public String getLibFolder(){
		...
		File basefile = new File( getBase() );
		
		String libFolder;
		if ( basefile.getAbsolutePath().endsWith(".jar") )
			libFolder = basefile.getParentFile().getAbsolutePath()+"/cts/";
		else // no jar eg. in eclipse
			libFolder = basefile.getParentFile().getAbsolutePath()+"/lib/cts/";
