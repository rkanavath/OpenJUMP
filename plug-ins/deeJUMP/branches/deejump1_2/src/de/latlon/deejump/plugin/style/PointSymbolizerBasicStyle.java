...
public class PointSymbolizerBasicStyle extends BasicStyle {
    ...
    public PointSymbolizerBasicStyle() {
        super();
        this.setVertexStyle( new CircleVertexStyle() );
    }
...
//        super.setEnabled( enable );
        if( this.vertexsStyle != null ){
            this.vertexsStyle.setEnabled( enable );  
        }
    }
    public boolean isEnabled(){
        return this.vertexsStyle != null ? this.vertexsStyle.isEnabled() : false;
    }
    ...
    public void setVertexStyle( VertexStyle vertexsStyle ){
        this.vertexsStyle = vertexsStyle;
        this.setEnabled( vertexsStyle.isEnabled() );
    }
}
