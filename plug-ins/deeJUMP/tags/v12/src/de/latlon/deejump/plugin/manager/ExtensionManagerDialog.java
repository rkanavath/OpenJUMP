...
public class ExtensionManagerDialog extends JDialog {
    ...
    public ExtensionManagerDialog(JFrame parent, WorkbenchContext workbenchContext, String extensionSite)
            throws Exception {
        super(parent, "Extension Manager");
        setSize(350, 500);
        setResizable(false);
        setModal( true );
...
*/
    ...
    private Component createTabbedPane() {
        ...
        JScrollPane pane = new JScrollPane(
                ...
                ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
                ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        panes.addTab("Installed Extensions", pane);
        ...
        panes.add("New Versions", newVersionsPanel);
...
//                updateExtensions();
    ...
    private void reReadCatalog() {
        try {
            ...
            JOptionPane.showMessageDialog( ExtensionManagerDialog.this, 
                    "You entered a malformed URL.", "Disgraceful Error!", JOptionPane.ERROR_MESSAGE );
        }
    }
    ...
    private ExtensionWrapper wrapExtension( Extension pluggedInExt ) {
        ...
        final String desc = "This extension has not been found in the catalogue.\n" +
            "It may have been added by copying into the lib/ext directory.";
        final String unknownCat = "unknown category";
        final String unknownAuthor = "unknown author";
        
        return new ExtensionWrapper( pluggedInExt.getName(), pluggedInExt.getName() + "(uncatalogued)",
                unknownAuthor, pluggedInExt.getVersion(), "unknown JUMP version", 
