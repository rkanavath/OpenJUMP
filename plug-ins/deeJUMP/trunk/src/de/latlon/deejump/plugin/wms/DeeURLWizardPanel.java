...
public class DeeURLWizardPanel extends JPanel implements WizardPanel {
    public static final String SERVICE_KEY = "SERVICE";
    public static final String FORMAT_KEY = "FORMAT";
    public static final String WMS_URL_LIST = "WMS_URL_LIST";
...
//  [UT]
    ...
    private ExtensibleComboBox extensibleComboBox = new ExtensibleComboBox(new Object[0] );
    public DeeURLWizardPanel(List initialURLs, String lastWmsUrl, String wmsVersion) {
        try {
            this.wmsVersion = wmsVersion;
            jbInit();
            for (Iterator iter = initialURLs.iterator(); iter.hasNext();) {
				extensibleComboBox.addItem((String)iter.next());
			}
            Object selectedItem = lastWmsUrl != null ? lastWmsUrl : initialURLs.get(0);
            
            extensibleComboBox.setSelectedItem( selectedItem );
    ...
    void jbInit() throws Exception {
        ...
        extensibleComboBox.setPreferredSize(new Dimension(350, 21));
        urlLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (SwingUtilities.isRightMouseButton(e) && e.getClickCount() == 3) {
                	extensibleComboBox.setSelectedItem("http://slkapps2.env.gov.bc.ca/servlet/com.esri.wms.Esrimap");
                }
...
//      [UT]
        ...
        String url = fixUrlForWMService( extensibleComboBox.getSelectedItem().toString() );
        //[UT] 20.04.2005 
        WMService service = new WMService( url, wmsVersion );
        //WMService service = new WMService( url );
        dataMap.put( WMS_URL, url);
        service.initialize();
