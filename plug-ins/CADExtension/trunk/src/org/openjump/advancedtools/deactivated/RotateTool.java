...
public class RotateTool extends DragTool {
    ...
    public Collection<Feature> getSelectedFeatures() {
        ...
        Collection selectedFeatures = selectionManager
    ...
    protected Shape createSelectedItemsShape()
            throws NoninvertibleTransformException {
        List selectedGeos = null;
        selectedGeos = (List) (getPanel().getSelectionManager()
                .getSelectedItems());
        ...
        geo = geomFac.createGeometryCollection(allGeoms);
        if (centerCoord == null) {
