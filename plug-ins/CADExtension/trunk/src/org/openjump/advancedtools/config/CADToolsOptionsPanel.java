...
public class CADToolsOptionsPanel extends JPanel implements OptionsPanel {
    ...
    private JLabel bufferRatio = new JLabel(
    ...
    private JCheckBox unionCheckbox = new JCheckBox(
    ...
    public JPanel getShowAngleAndLenghtPanel() {
    ...
    public static final boolean getShowAngleAndLenght() {
        return PersistentBlackboardPlugIn.get(
                JUMPWorkbench.getInstance().getFrame().getContext()).get(
