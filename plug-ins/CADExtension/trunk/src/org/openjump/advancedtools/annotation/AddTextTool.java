...
public class AddTextTool extends NClickTool {
    ...
    private Cursor addtxtcursor = createCursor(new ImageIcon(IconLoader.icon(
            "textblock/annotation_add.gif").getImage()).getImage());

    private Cursor modifytxtcursor = createCursor(new ImageIcon(IconLoader
    ...
    private ImageIcon icon = IconLoader.icon("textblock/annotation_add.png");
