            ...
            public void featuresChanged(FeatureEvent e) {
                ...
                if (e.getLayer().equals(textLayer)) {
                    ...
                    for (Feature feature : features) {
                        feature.setAttribute(LAYER, new String("TEXT"));
                        // feature.setAttribute(TEXT, new
                        // Double(myTextArea.setText(f.getString(TEXT))));
                        feature.setAttribute(TEXT_HEIGHT, new Double(rotation));
                        feature.setAttribute(TEXT_ROTATION, new Double(
                                dimension));
                        feature.setAttribute(TEXT_STYLE, new String("STANDARD"));
