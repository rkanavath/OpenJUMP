...
public class SimpleLineDialog extends JDialog implements ActionListener,
    ...
    public void setFirstPointAbsoluta(double x, double y) {
        ...
        jspunto1AbsolutaX.setValue(Double.valueOf(x));
        jspunto1AbsolutaY.setValue(Double.valueOf(y));
        aceptarAction();
    }
    ...
    public void setSecondPointAbsoluta(double x, double y) {
        ...
        jspunto2AbsolutaX.setValue(Double.valueOf(x));
        jspunto2AbsolutaY.setValue(Double.valueOf(y));
        aceptarAction();
    }
    ...
    public void setSecondPointRelativa(double x, double y) {
        ...
        jspunto2RelativoX.setValue(Double.valueOf(x));
        jspunto2RelativoY.setValue(Double.valueOf(y));
        aceptarAction();
    }
     ...
     * @param parametro2
     */
    public void setSecondPointLongAngulo(double longitud, double angulo) {
        punto2longitudAngulo.doClick();
        jspunto2Longitud2.setValue(longitud);
        jspunto2Angulo.setValue(angulo);
        aceptarAction();
    }
