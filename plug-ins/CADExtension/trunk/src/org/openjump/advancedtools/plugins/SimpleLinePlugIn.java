...
public class SimpleLinePlugIn extends AbstractPlugIn {
    ...
    public void selectManualTool(int nPuntosACapturar, Coordinate c1,
            Coordinate c2) {
        DrawSimpleLineTool dslt = new DrawSimpleLineTool(nPuntosACapturar, sld,
                c1, c2);
        QuasimodeTool quasimodeTool = WorkbenchUtils
                .addStandardQuasimodes(dslt);
    ...
    public void save() throws Exception {
        ...
        WorkbenchUtils.executeUndoableAddNewFeats(NAME, selectionManager,
