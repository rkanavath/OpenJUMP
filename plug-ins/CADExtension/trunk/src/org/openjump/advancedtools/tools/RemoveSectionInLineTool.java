...
public class RemoveSectionInLineTool extends NClickTool {
    public static final Logger LOGGER = Logger
            .getLogger(RemoveSectionInLineTool.class);
    ...
    protected void gestureFinished() throws Exception {
        ...
        Set<LineString> geometries = new HashSet<LineString>();
        ...
        geometries.addAll(newGeometries); // add the new lines result to the
                                          // geometries
    ...
    protected void gestureFinished(final Layer affectedLayer,
        ...
        final List<Feature> updatedFeatures = new ArrayList<Feature>();
        updatedFeatures.add(featEdited);
        final List<Feature> origFeatures = new ArrayList<Feature>();
