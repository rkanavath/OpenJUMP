...
public class ExtendToClickedGeometryTool extends ExtendRectLineTool {
     ...
     * 
     */
    protected Map getCandidates1(Coordinate c, double r, Feature f) {
    ...
    protected Map getCandidates(Coordinate c, double r, Feature f) {
        HashMap s = new HashMap();
    ...
    protected Layer[] getVisibleLayers() {
        Collection visibleLayers = JUMPWorkbench.getInstance().getFrame()
