 ...
 * @author Sergio Baños Calvo - Changed code to use the parallel algorithm
...
public class ParalelLineTool extends DragTool {
    ...
    String sDistance = I18NPlug
            .getI18N("org.openjump.core.ui.plugins.Dialog.Length");
    ...
    /**
     * Not used. giving A coordinate a and a geometry, it gets the closest
     * coordinate B (of the geometry) to A
     * 
     * @param Coordinate
     *            A
     * @param Geometry
