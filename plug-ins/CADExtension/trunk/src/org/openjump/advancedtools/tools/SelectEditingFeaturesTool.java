...
public class SelectEditingFeaturesTool extends SelectTool {
    ...
    protected void gestureFinished() throws NoninvertibleTransformException {
        ...
        Collection selgeom = layerViewPanel.getSelectionManager()
    ...
    protected void deselectFeatures(Geometry selectionGeom) throws Exception {
        reportNothingToUndoYet();
        WorkbenchUtils.discardSelection();
        // Filtramos por la capa en edicion
        /*
    ...
    protected List<Layerable> getLayersFilter() {
        List<Layerable> layerFilter = new ArrayList<Layerable>();
        Collection editableLayers = getPanel().getLayerManager()
                .getEditableLayers();
        if (editableLayers.isEmpty()) {
            return null;
        }
        Layer editableLayer = (Layer) editableLayers.iterator().next();
