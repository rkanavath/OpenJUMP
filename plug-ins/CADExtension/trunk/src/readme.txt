...
This set of tools have been mostly adapted from Kosmo SAIG Cad Tools (version 3.0) 
and SkyJUMP (version  1.2 - ConstrainedNClickTool class). 
Other enhancements have been adapted from OpenJUMP 1.10 source code

All copyright reserved under GNU version 3
except org.openjump.advancedtools.tools.ConstrainedNClickTool
which is under GNU version 2
