...
public class PolygonShapeMeasures {
    ...
    /**
     * Calculates the radius of a circle with the given area.
     * @param area of a polygon object
     * @return the radius of a circle with the same area
     */
    public static double calcCircleRadiusFromArea(double area){
