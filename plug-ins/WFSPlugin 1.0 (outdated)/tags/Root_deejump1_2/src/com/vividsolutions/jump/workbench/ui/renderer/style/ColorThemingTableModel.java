...
//            this.vertexStyle = vertexStyle;
    ...
    protected List createColumns(final FeatureSchema schema) {
        ...
        columns.add(new Column(I18N.get("ui.renderer.style.ColorThemingTableModel.attribute-value"), null) {
            ...
            public void setValueAt(Object value, int rowIndex) {
            	System.out.println("Attributte Value " + rowIndex +" "+ value);
    ...
    public static class AttributeValueTableModelEvent extends TableModelEvent {
        public AttributeValueTableModelEvent(TableModel source, int row) {
            super(source, row);
            System.out
					.println("AttributeValueTableModelEvent.AttributeValueTableModelEvent() ");
        }

    }
    //GH 2005.10.25
    /*public  void setVertexStyleAt(Object value, int rowIndex) {
    	 attributeMapping(rowIndex).setVertexStyle(( VertexStyle) value);
    }*/
    ...
    /*public Map getAttributeValueToVertexStyleMap() {
        return attributeValueToObjectMap(new Block(){
            public Object yield(Object attributeMapping) {
                return ((AttributeMapping)attributeMapping).getVertexStyle();
            }
        });
    }*/
