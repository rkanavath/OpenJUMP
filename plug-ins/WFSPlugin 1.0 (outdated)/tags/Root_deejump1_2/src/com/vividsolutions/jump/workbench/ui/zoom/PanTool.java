...
public class PanTool extends DragTool {
    ...
    private void cacheImage() {
    	aux   = getPanel().createBlankPanelImage();
    ...
    private void drawImage(Point p) throws NoninvertibleTransformException {
        ...
        aux.getGraphics().fillRect(0,0,aux.getWidth(getPanel()),aux.getHeight(getPanel()));
        aux.getGraphics().drawImage(image, (int) dx, (int) dy, getPanel());
        getPanel().getGraphics().drawImage(aux, (int) 0, (int) 0, getPanel());
    }
}
