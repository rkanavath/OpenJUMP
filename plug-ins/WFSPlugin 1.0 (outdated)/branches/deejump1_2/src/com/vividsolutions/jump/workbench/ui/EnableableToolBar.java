...
public class EnableableToolBar extends JToolBar {
    ...
    protected HashMap buttonToToolTipMap = new HashMap();
    ...
    public void updateEnabledState() {
        for (Iterator i = buttonToEnableCheckMap.keySet().iterator();
            ...
            String mesg = enableCheck.check(component);
            component.setEnabled( mesg == null);
            if ( mesg == null ){
                mesg = (String)buttonToToolTipMap.get(component);
            } 
            component.setToolTipText( mesg );
        }
    ...
    public void add(
        ...
        if (enableCheck != null) {
            ...
            buttonToToolTipMap.put(button, tooltip );
        }
        button.setIcon(icon);
