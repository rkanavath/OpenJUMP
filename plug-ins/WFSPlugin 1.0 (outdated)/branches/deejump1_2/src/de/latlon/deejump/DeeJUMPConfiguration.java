...
import de.latlon.deejump.plugin.ct.TransformationPlugIn;
import de.latlon.deejump.plugin.manager.ExtensionManagerPlugIn;
import de.latlon.deejump.plugin.project.DeeOpenProjectPlugIn;
import de.latlon.deejump.plugin.project.DeeSaveProjectAsPlugIn;
import de.latlon.deejump.plugin.project.DeeSaveProjectPlugIn;
...
//    private SaveImageAsSVGPlugIn imageSvgPlugin= new SaveImageAsSVGPlugIn();
    ...
    InstallKeyPanPlugIn navigationPlugin = new InstallKeyPanPlugIn();
...
//  	private SynchroWFSLayerPlugIn synchroWFSLayerPlugIn = new SynchroWFSLayerPlugIn();
  	...
  	private TransformationPlugIn coordSysTransf = new TransformationPlugIn();
...
//  	private CustomInstallScalePlugIn customInstallScale = new CustomInstallScalePlugIn(); 
    ...
    private DeeSaveProjectAsPlugIn saveProjectAsPlugIn = new DeeSaveProjectAsPlugIn();

    private DeeSaveProjectPlugIn saveProjectPlugIn = new DeeSaveProjectPlugIn(
            saveProjectAsPlugIn);

    private DeeOpenProjectPlugIn openProjectPlugIn = new DeeOpenProjectPlugIn();
    ...
    private void configureMainMenus(final WorkbenchContext workbenchContext,
        ...
        featureInstaller.addLayerViewMenuItem(addDatastoreLayerPlugIn, MenuNames.LAYER,
                                              addDatastoreLayerPlugIn.getName() + "...");
        featureInstaller.addLayerViewMenuItem(runDatastoreQueryPlugIn, MenuNames.LAYER,
...
/*        featureInstaller.addMainMenuItem(synchroWFSLayerPlugIn, MenuNames.LAYER,
		...
		*/
        ...
        featureInstaller.addMainMenuItem(coordSysTransf,
        		MenuNames.LAYER, coordSysTransf.getName(), null,
        		coordSysTransf.createEnableCheck(workbenchContext));
        
        /* featureInstaller.addMainMenuItem(coordSysTransf2,
        		MenuNames.LAYER, coordSysTransf.getName(), null,
        		coordSysTransf.createEnableCheck(workbenchContext));
*/
...
/*        ThreeDPlugIn t3d = new ThreeDPlugIn();
        frame.getToolBar().addPlugIn(t3d.getIcon(),
                                     t3d , t3d.createEnableCheck( workbenchContext ), workbenchContext); 
*/
