...
public class WMSViewer extends JFrame implements ActionListener, MouseListener {
   ...
   */
  public WMSViewer() {
    super( I18N.get("ui.WMSViewer.wms-viewer") );
    ...
    topPanel.add( new JLabel( I18N.get("ui.WMSViewer.server-string")) );
    serverUrlField = new JTextField( I18N.get("ui.WMSViewer.wms-url"), 30 );
    topPanel.add( serverUrlField );
    connectButton = new JButton( I18N.get("ui.WMSViewer.connect") );
    connectButton.setActionCommand( "connect" );
    connectButton.addActionListener( this );
    topPanel.add( connectButton );
    disconnectButton = new JButton( I18N.get("ui.WMSViewer.disconnect") );
    ...
    JRadioButton rb = new JRadioButton( I18N.get("ui.WMSViewer.pan") );
    ...
    thePanel.add( rb );
    bg.add( rb );
    rb = new JRadioButton( I18N.get("ui.WMSViewer.zoom-in") );
    rb.setActionCommand( "zoomIn" );
    rb.addActionListener( this );
    thePanel.add( rb );
    bg.add( rb );
    rb = new JRadioButton( I18N.get("ui.WMSViewer.zoom-out"));
    ...
    getImageButton = new JButton( I18N.get("ui.WMSViewer.get-image") );
